 ...
 *   },
 *   links = {
 *     "collection" = "/admin/finance/reward",
 *     "add-form" = "/admin/finance/reward/add/{type}",
 *     "add-page" = "/admin/finance/reward/add",
 *     "canonical" = "/admin/finance/reward/{reward}",
 *     "edit-form" = "/admin/finance/reward/{reward}/edit",
 *     "delete-form" = "/admin/finance/reward/{reward}/delete",
 *     "delete-multiple-form" = "/admin/finance/reward/delete-multiple",
 *   },
